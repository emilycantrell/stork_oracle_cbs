...
# This jobfile is slightly different from the one that produced
# results/results_extrapolation_seed_1_2025-08.xlsx. For that file, we
# ran the code with 2000 bootstraps and two additional metrics: In_Sample_R2
# and AUC. This caused the jobfile to take more than a week to run. We ended up
# simplifying the jobfile for seeds 2 through 5, as we realized that the 
# extrapolation section of our paper did not really require bootstrapped 
# confidence intervals. To save time for reproduction, we present a simplified
...
# Train-test splits 
sampling_files <- c("dms_samples_seed_1_subsamples_1.csv",
                    "dms_samples_seed_1_subsamples_2.csv",
                    "dms_samples_seed_1_subsamples_3.csv",
                    "dms_samples_seed_1_subsamples_4.csv",
                    "dms_samples_seed_1_subsamples_5.csv")
...
results_path <- "results/results_extrapolation_seed_1_2025-08.csv"