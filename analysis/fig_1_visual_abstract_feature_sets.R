...
results_AS_FS <- read_excel(here("results/results_learning_curves_seed_1_2025-08.xlsx")) %>%
...
results_winning_model <- read_excel(here("results/results_learning_curves_seed_1_2025-08.xlsx")) %>%
...
ggsave(
  filename = paste0(
    here("analysis/plots_and_tables_output/fig_1_visual_abstract_feature_sets"),
    eval_set_label_for_saved_file, 
    ".png"
  ),
  width = 6,
