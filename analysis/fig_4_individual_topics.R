...
results_six_topics_seed_1 <- read_excel(here("results/results_individual_topics_seed_1_2025-08.xlsx"))
results_six_topics_seeds_2_to_5 <- read_excel(here("results/results_individual_topics_seeds_2-5_2025-08.xlsx"))
training_sets_for_this_plot <- unique(results_six_topics_seed_1$training_set)
results_winning_and_asfs_seed_1 <- read_excel(here("results/results_learning_curves_seed_1_2025-08.xlsx")) %>%
  filter(training_set %in% training_sets_for_this_plot,
         feature_set %in% c("without_leakage", "AS_FS"))
results_winning_and_asfs_seeds_2_to_5 <- read_excel(here("results/results_learning_curves_seeds_2-5_2025-08.xlsx")) %>%
  filter(training_set %in% training_sets_for_this_plot,
         feature_set %in% c("without_leakage", "AS_FS"))
...
ggsave(
  filename = paste0(
    here("analysis/plots_and_tables_output/fig_4_individual_topics"),
    eval_set_label_for_saved_file, 
    ".png"
  ),
  width = 8,
