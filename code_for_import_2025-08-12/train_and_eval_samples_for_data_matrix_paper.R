...
#train_path <- "H:/DATASETS/train.csv" # This might be different in the new environment, Mark will need to fill it in
train_path <- "~/Documents/GitHub/prefer_pmt_umbrella/train_and_eval_samples/fake_prefer_train_and_eval.csv" # temporary line
...
# This path should go to holdout_final_leaderboard.csv from Lisa - Mark will need to fill it in
# holdout_path <- "H:/stork_oracle/data/holdout_final_leaderboard.csv" # I'm not sure if this is the correct path
holdout_path <- "~/Documents/GitHub/prefer_pmt_umbrella/train_and_eval_samples/fake_holdout_set.csv" # temporary line
...
# original_sampling_file_path <- # Mark will need to fill this in 
original_sampling_file_path <- "~/Documents/GitHub/prefer_pmt_umbrella/train_and_eval_samples/fake_sampling_file_with_eval_splits.csv"
...
setwd("~/Documents/Dutch_Registry/fake_sampling_files")
