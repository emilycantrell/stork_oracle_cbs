...
# This file produces indicators that split the data into an official holdout
# set, an internal validation set (evaluation_test_50_percent_split), an
# internal selection set (evaluation_test_50_percent_split), and an inner
# training set (training_set).
# This file also produces smaller nested subsets of the training set, but these
# smaller subsets are not used for the main paper. For the subsets used in the
# main paper, see 2_train_and_eval_samples_for_data_matrix_paper.R.
...
edit_and_save_sample_df <- function(seed) { 
  ...
  # Save results 
  file_name <- paste0("train_and_evaluation_samples_seed_", seed, "_241016_with_holdout.csv")
  pmt_samples_path_to_write <- paste0("data/", file_name)
