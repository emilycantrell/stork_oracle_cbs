...
feature_set_settings <- list(
  dems_immigration = c("family_age_and_sex_from_prefer_submission", "family_structure", "immigration_ethnicity"),
  dems_income = c("family_age_and_sex_from_prefer_submission", "family_structure", "income_assets_benefits"),
  dems_education = c("family_age_and_sex_from_prefer_submission", "family_structure", "education"),
  dems_employment = c("family_age_and_sex_from_prefer_submission", "family_structure", "employment"),
  dems_housing = c("family_age_and_sex_from_prefer_submission", "family_structure", "housing"),
  dems_childcare = c("family_age_and_sex_from_prefer_submission", "family_structure", "childcare_proximity")
)
...
results_path <- "results_plot5a_2025-04-23.csv"