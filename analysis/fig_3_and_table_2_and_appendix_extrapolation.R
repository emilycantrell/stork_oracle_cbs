...
tables_file <- here(
  "analysis/plots_and_tables_output",
  paste0(
...
for (my_metric in metrics_to_run) {
  ...
  for(main_seed in c(1:5)) {
    ...
    lower_n_results <- switch(
      main_seed_string,
      "1" = read_excel(here("results/results_extrapolation_seed_1_2025-08.xlsx")),
      "2" = read_excel(here("results/results_extrapolation_seed_2_2025-08.xlsx")),
      "3" = read_excel(here("results/results_extrapolation_seed_3_2025-08.xlsx")),
      "4" = read_excel(here("results/results_extrapolation_seeds_4-5_2025-08.xlsx")) %>%
        filter(str_starts(sampling_file, "dms_samples_seed_4")),
      "5" = read_excel(here("results/results_extrapolation_seeds_4-5_2025-08.xlsx")) %>%
    ...
    higher_n_results <- if (main_seed_string == "1") {
      read_excel(here("results/results_learning_curves_seed_1_2025-08.xlsx"))
    } else if (main_seed_string %in% c("2", "3", "4", "5")) {
      read_excel(here("results/results_learning_curves_seeds_2-5_2025-08.xlsx")) %>%
  ...
  panel_file_name <- paste0(
    here("analysis/plots_and_tables_output/appendix_extrapolation_panel_"),
  ...
  if(my_metric == "R2_Holdout") {
    ...
    solo_plot_file_name <- paste0(
      here("analysis/plots_and_tables_output/fig_3_extrapolation_"),
      metric_label_for_saved_file,
      eval_set_label_for_saved_file,
      ".png"
    )
