...
run_metric <- function(my_metric) {
  ...
  results_seed_1 <- results_seed_1 <- read_excel(here("exports/export_2025-09-15_mark/results_learning_curves_seed_1_2025-08.xlsx"))
  results_seeds_2_5 <- read_excel(here("exports/export_2025-09-15_mark/results_learning_curves_seeds_2-5_2025-08.xlsx"))
  ...
  # Save the plot
  ggsave(
     filename = paste0("plots_and_tables_output/fig_2_learning_curves_", 
