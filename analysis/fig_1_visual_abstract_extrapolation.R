...
lower_n_results <- switch(
  ...
  "2" = read_excel(here("results/results_extrapolation_seeds_2_2025-08.xlsx")),
  "3" = read_excel(here("results/results_extrapolation_seeds_3_2025-08.xlsx")),
...
ggsave(
  filename = paste0(
    here("analysis/plots_and_tables_output/fig_1_visual_abstract_extrapolation"),
    eval_set_label_for_saved_file, 
    ".png"
  ),
  width = 10,
